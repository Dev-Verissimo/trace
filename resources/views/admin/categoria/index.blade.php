...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li class="active"><a href="{{route('admin.categoria.index')}}"> <i class="fa fa-sitemap mr5"></i>Categorias</a>
        </li>
    </ol>
    ...
    <div class="well well-asset-options clearfix">
        ...
        <div class="btn-group pull-right">
            <div class="btn-group" role="group">
                <a role="button" href="{{route('admin.categoria.create')}}" type="button"
