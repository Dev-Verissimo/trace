...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li class=""><a href="{{route('admin.arquivo.index', $id)}}">Arquivos do Equipamento</a></li>
        <li class="active"><a href="{{route('admin.arquivo.create', $id)}}">Adicionar Arquivo</a></li>
    </ol>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel">
                <form action="{{route('admin.arquivo.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="panel-heading">
                        <h4 class="panel-title">Adicionar Arquivo </h4>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nome" id="nome" value="{{old('nome')}}" required placeholder="Nome"
                                   class="form-control"/>
                        </div>
                        <div class="form-group">
