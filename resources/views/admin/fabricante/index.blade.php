...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li class="active"><a href="{{route('admin.fabricante.index')}}"> <i class="fa fa-gears mr5"></i>Fabricantes</a>
        </li>
    </ol>
    ...
    <div class="well well-asset-options clearfix">
        ...
        <div class="btn-group pull-right">
            <div class="btn-group" role="group">
                <a role="button" href="{{route('admin.fabricante.create')}}" type="button"
                        ...
                        <table class="table table-bordered table-default table-striped nomargin">
                            ...
                            @foreach($fabricantes as $fabricante)
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{route('admin.fabricante.edit', $fabricante->id)}}"
                                           class="btn btn-success text-white rounded-circle " title="Editar Usuário">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="{{route('admin.fabricante.show', $fabricante->id)}}" type="button"
