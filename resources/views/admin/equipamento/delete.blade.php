...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li class="active"><a href="{{route('admin.equipamento.show', $equipamento->id)}}">Excluir Equipamento</a></li>
    </ol>
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h4 class="panel-title">Excluir Equipamento </h4>
                </div>
                <form action="{{route('admin.equipamento.destroy', $equipamento->id)}}" method="post"  enctype="multipart/form-data">
                    @csrf
                    @method('DELETE')
                    ...
                    <div class="panel-footer">
                        <button type="submit" class="btn btn-success btn-quirk btn-wide mr5">Excluir</button>
